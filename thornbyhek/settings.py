...
# Stripe Account A
STRIPE_SECRET_KEY_A = os.getenv("STRIPE_SECRET_KEY_A")
STRIPE_PUBLIC_KEY_A = os.getenv("STRIPE_PUBLIC_KEY_A")
STRIPE_WEBHOOK_SECRET_A = os.getenv("STRIPE_WEBHOOK_SECRET_A")

# Stripe Account B
STRIPE_SECRET_KEY_B = os.getenv("STRIPE_SECRET_KEY_B")
STRIPE_PUBLIC_KEY_B = os.getenv("STRIPE_PUBLIC_KEY_B")
STRIPE_WEBHOOK_SECRET_B = os.getenv("STRIPE_WEBHOOK_SECRET_B")
